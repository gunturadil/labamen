...
elseif ($_GET[hal]=="profil") {
	include "sidebar.php";
	$sql  = mysqli_query($conn, "SELECT * FROM modul WHERE id_modul='2'");
...
elseif ($_GET[hal]=="panduan") {
	include "sidebar.php";
	$sql  = mysqli_query($conn, "SELECT * FROM modul WHERE id_modul='3'");
    $r    = mysqli_fetch_array($sql);
...
//Home
	...
	include "sidebar.php";
	$sql  = mysqli_query($conn, "SELECT * FROM modul WHERE id_modul='1'");
    $r    = mysqli_fetch_array($sql);
